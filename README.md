...
- [Data Modelling for Data Products](https://www.moderndata101.com/masterclass/data-modeling-for-data-products): A comprehensive masterclass on data modeling for high-impact and high-value data products. The session details how to develop flexible, domain-driven data models and implement robust governance using essential tools like metric trees and semantic layers, ensuring that business value remains top of mind throughout the process.
- [Building an End-to-End Open-Source Modern Data Platform](https://medium.com/data-science/building-an-end-to-end-open-source-modern-data-platform-c906be2f31bd): Proposes an exhaustive design (accompanied by the necessary Infrastructure-as-Code) to build a modern data platform solely using open-source projects and the resources offered by cloud providers.
- [Writing design docs for data pipelines](https://medium.com/data-science/writing-design-docs-for-data-pipelines-d49550f95580): Exploring the what, why, and how of design docs for data components — and why they matter.
- [The Data Team's Survival Guide for the Next Era of Data](https://towardsdatascience.com/the-data-teams-survival-guide-for-the-next-era-of-data/): 6 pillars for data teams to declutter their stack, escape the service trap, and build the missing foundations for the new primary data consumer: the AI agent.
...
- [Building a Semantic Layer for the AI Era: Beyond SQL Generation](https://blog.dataengineerthings.org/semantic-layer-for-ai-beyond-sql-aae652837a5a): A guide to capturing the “What, Why, and Who” for Agent functionality.
...
- [Navigating Your Data Platform’s Growing Pains: A Path from Data Mess to Data Mesh](https://medium.com/data-science/navigating-your-data-platforms-growing-pains-a-path-from-data-mess-to-data-mesh-c16df72f5463): A set of strategies and guiding principles to scale your data platform while maximizing its business impact efficiently.
- [A Simple (Yet Effective) Approach to Implementing Unit Tests for dbt Models](https://medium.com/data-science/a-simple-yet-effective-approach-to-implementing-unit-tests-for-dbt-models-da2583ea8e79): Proposes an innovative unit testing approach for dbt models - relying on standards and dbt best practices.
- [Creating Notebook-based Dynamic Dashboards](https://medium.com/data-science/creating-notebook-based-dynamic-dashboards-91f936adc6f3): A design (accompanied by a POC) in which notebooks are leveraged to generate dynamic dashboards, to support a Google-like metadata search engine.
